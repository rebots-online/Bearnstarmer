...
This monorepo hosts the tl;justdraw! platform, now centered on an Excalidraw-powered collaborative canvas (chosen after tldraw v4 licensing changes), Excalidraw library ingestion, always-on LLM facilitation, SSO authentication, RevenueCat billing, and deployable clients for web (PWA) and desktop/mobile (Tauri).
